...
awful.rules.rules = {
    ...
    -- Pavucontrol
    {
        ...
        properties = { tiling = true, width = screen_width * 0.45, height = screen_height * 0.8 }
    },
    ...
    -- Galculator
    {
        ...
        properties = { tiling = true, width = screen_width * 0.2, height = screen_height * 0.4 }
    },
    ...
    -- File managers
    {
        ...
        properties = { tiling = true, width = screen_width * 0.45, height = screen_height * 0.55}
    },
